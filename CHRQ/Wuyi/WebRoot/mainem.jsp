...
name=topFrame src="top1.jsp" noResize scrolling=no><FRAMESET 
border=0 frameSpacing=0 frameBorder=no cols=20%,*><FRAME id=leftFrame 
name=leftFrame src="left1.jsp" noResize scrolling=no><FRAME 
id=mainFrame name=mainFrame src="e1.jsp" noResize 
