...
<DIV>
  ...
  height=47>
      ...
      style="PADDING-RIGHT: 10px; PADDING-LEFT: 10px; FLOAT: left; BACKGROUND-IMAGE: url(../images/main_hb.gif); PADDING-BOTTOM: 10px; COLOR: white; PADDING-TOP: 10px; BACKGROUND-REPEAT: repeat-x; HEIGHT: 47px; TEXT-ALIGN: center; 0px: ">Lifestyle Risk </SPAN><SPAN 
 ...
 <a   href="Eating_input.jsp"  target="lifemain"><img  src="images/commonsick/food.jpg" width="130" height="130"></a>
   
    <a   href="Active_eating_input.jsp" target="lifemain" ><img  src="images/commonsick/activity.jpg" width="130" height="130"></a>
      <a   href="Sleep_input.jsp"  target="lifemain"><img  src="images/commonsick/sleep.jpg" width="130" height="130"></a>
   
<br>
<div   id=show align="left">Result:</div>
<iframe name="Eating_result" width="300"  height="70" align="left"></iframe><div   id=show></div>
   <iframe name="Active_eating_result" width="300"  height="70" align="left"></iframe><div  id=show></div>
   <iframe name="Sleep_result" width="280"  height="70" align="left"></iframe><div  id=show></div>
<br><br>
  <br>
  <br>
  <br>
  <div   id=show align="left">Form:</div>
  <iframe name="lifemain" width="690"  height="100" align="left"></iframe><div id=show></div>
  <br><br>
   <a href="life_Solution.jsp" target="solution"> <a href="Solution.jsp" target="solution"> >>How to growth better</a>  
  <br><br><br><br>
  
  <div   id=show align="left">Solution:</div>
  <iframe name="solution" width="690"  height="150" align="left"></iframe><div id=show></div> 
